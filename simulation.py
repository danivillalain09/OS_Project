...
def run_simulation(number_of_boats, number_of_docks, number_of_cranes, number_of_transporters, disable_delay, disable_priority):
    ...
    sql.add_columns(Boats(1, control, sql, 0, False, False), Container(0, 0, "E", "S", "C"),

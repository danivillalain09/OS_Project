        ...
        while not found_and_emptied:
            for storage_areas in mediator.container_storage:
                ...
                if storage_dictionary["Locker"].locked():
                    ...
                    print(f"WORKER: {Fore.CYAN}Transported containers to {storage_areas}.{Style.RESET_ALL}")
...
print("----------------------------------------------------------------------")
#print("bla, bla, bla, bla, bla, bla") # In the simulation we will generate a database in order for you to see the results,
# However, the main points you will see them here.
# The simulation will run for a day, and you will see the results of the simulation in the console.
...
print("This will be the people that will work for you in the port and their respective jobs: ")
...
with concurrent.futures.ThreadPoolExecutor(max_workers=number_of_cranes) as executor:
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=3) as executor:
            ...
            with concurrent.futures.ThreadPoolExecutor(max_workers=1) as executor:
                ...
                print("----------------------------------------------------------------------")
                text = "_____SIMULATION BEGINNING_____"
                ...
                print("----------------------------------------------------------------------")
                print("Now, let's see the results of the simulation.")
